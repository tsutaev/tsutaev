### Hi there! I am Igor Tsutaev. Python Software Developer with 3+ years of experience.
...
* Web:	HTTP, HTML5, CSS3, REST API, Swagger, Strapi, nginx, Portainer
* Testing, parsing:	Selenium, Playwright, PyTest, Unittest, Beautiful Soup, Scrapy, Requests, Aiohttp, Httpx
* Devops, CI/CD:	Git (Github, Gitlab), Docker, Kubernetes, Jenkins, Drone CI, Ansible
* Messaging, monitoring:	Celery, Kafka, RabbitMQ, Prometheus, Grafana, Grafana Loki, Btop++
* Tools: 	VSCode, PyCharm, Jupiter Notebook, Git Bash, Vim, Postman, Bruno
